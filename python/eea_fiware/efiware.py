...
class Efiware(object):
    ...
    def create_service_group(self, api_key, entity_type, data_model):
        ...
        try:
            ...
            params = {}
            headers = {"Content-Type": "application/json", "fiware-service": EfConfig.FIWARE_SERVICE, "fiware-servicepath": "/" + entity_type}
            ...
            raise EfException("Unable to create service group. Probably because it already exists")
    ...
    def __init__(self, api_key, entity, timestamp, payload):
        ...
        if Efiware.CREATE_SERVICE_GROUP:
            ...
            try:
                self.create_service_group(EfConfig.FIWARE_APIKEY, EfConfig.FIWARE_ENTITY, EfConfig.FIWARE_DATAMODEL)
